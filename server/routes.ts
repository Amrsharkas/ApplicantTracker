...
IMPORTANT: Only include items in missingRequirements that the user clearly lacks. Be specific and factual.`;
  ...
  // Populate profile with provided data
  app.post("/api/populate-profile", requireAuth, async (req, res) => {
    try {
      const userId = (req.user as any)?.id;
      
      // Raef Samir's profile data
      const profileData = {
        personalDetails: {
          firstName: "Raef",
          lastName: "Samir",
        ...
        governmentId: {
          idType: "national-id",
          idNumber: "29905142345678",
          verified: true
        },
        linksPortfolio: {
          linkedinUrl: "https://linkedin.com/in/raef-samir",
          personalWebsite: "https://raefsamirfinance.com",
          otherLinks: [{
            platform: "Research Article",
            url: "https://financejournal.com/article/raef-samir"
          }]
        },
        workEligibility: {
          workAuthorization: "citizen",
          willingToRelocate: true,
          preferredLocations: ["UAE", "KSA", "UK", "Canada"],
        ...
        skills: {
          technicalSkills: [
            { skill: "Financial Analysis", level: "advanced", yearsOfExperience: 3 },
            { skill: "Budget Forecasting", level: "advanced", yearsOfExperience: 2 },
            { skill: "Microsoft Excel", level: "expert", yearsOfExperience: 5 },
            { skill: "Data Visualization (Power BI, Tableau)", level: "intermediate", yearsOfExperience: 1 },
            { skill: "Investment Portfolio Management", level: "intermediate", yearsOfExperience: 2 }
          ],
          softSkills: [
            { skill: "Strategic Thinking", level: "advanced" },
            { skill: "Problem-Solving", level: "advanced" },
            { skill: "Communication Skills", level: "advanced" },
        ...
        education: [{
          ...
          fieldOfStudy: "Finance and Economics",
          startDate: "2017-09",
          endDate: "2021-06",
          current: false,
          gpa: "3.8/4.0",
          honors: "High Honors",
          relevantCoursework: "Member of AUC Finance Society, CFA Research Challenge Finalist"
        }],
        experience: [
          {
            company: "HSBC Egypt",
            ...
            responsibilities: "Conducted detailed financial analysis for corporate clients. Created monthly budget forecasts and variance reports. Assisted in structuring investment portfolios for SMEs.",
            achievements: "Reduced analysis time by 20% by automating Excel workflows. Managed EGP 50M in investment portfolios with 12% annual ROI.",
            technologies: ["Microsoft Excel", "Power BI", "Bloomberg Terminal"],
            teamSize: 12
          },
          {
            ...
            current: false,
            location: "Cairo, Egypt",
            responsibilities: "Supported audit teams with financial statement analysis. Conducted preliminary risk assessments for clients."
          }
        ],
        certifications: [{
          ...
          issueDate: "2023-01",
          credentialId: "CFA123456789"
        }],
        awards: [{
          title: "CFA Research Challenge Finalist",
          issuer: "CFA Society Egypt",
          dateReceived: "2021-04",
          description: "Led a 3-member team to develop a 50-page equity research report for a publicly listed company.",
          category: "academic"
        }],
        jobTarget: {
          targetRoles: ["Financial Analyst", "Investment Analyst", "Corporate Finance Associate"],
          targetIndustries: ["Banking", "Consulting", "Asset Management"],
          careerLevel: "junior",
          salaryExpectations: {
            minSalary: 25000,
            maxSalary: 30000,
          ...
          careerGoals: "Financial Planning & Analysis, Investment Advisory, Risk Assessment",
          workStyle: "Collaborative with strategic autonomy"
        }
      };
      ...
      const dbProfileData: InsertApplicantProfile = {
        ...
        email: profileData.personalDetails.email,
        phone: profileData.personalDetails.phone,
        birthdate: profileData.personalDetails.dateOfBirth,
        gender: null,
        nationality: profileData.personalDetails.nationality,
        country: profileData.personalDetails.address.country,
        city: profileData.personalDetails.address.city,
        ...
        githubUrl: null,
        websiteUrl: profileData.linksPortfolio.personalWebsite,
        otherUrls: profileData.linksPortfolio.otherLinks?.map(link => link.url) || null,
        willingToRelocate: profileData.workEligibility.willingToRelocate,
        preferredWorkCountries: profileData.workEligibility.preferredLocations,
        workplaceSettings: profileData.workEligibility.workArrangement,
        languages: profileData.languages,
        skillsList: [
          ...profileData.skills.technicalSkills.map(skill => skill.skill),
          ...profileData.skills.softSkills.map(skill => skill.skill)
        ],
        degrees: profileData.education,
        workExperiences: profileData.experience,
        certifications: profileData.certifications,
      ...
      try {
        await airtableService.storeUserProfile(
          dbProfileData.name!,
          {
            type: 'comprehensive',
            data: profileData,
            summary: `Complete profile for ${dbProfileData.name} (${completionPercentage}% complete)`,
            completionPercentage,
      ...
      res.status(500).json({ message: "Failed to populate profile" });
    }
  });
