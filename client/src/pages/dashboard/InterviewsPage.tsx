  ...
  return (
    <div className="space-y-8">
      ...
      {isLoading ? (
        ...
        >
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-900 backdrop-blur-sm border-blue-200/60 dark:border-slate-700/60 overflow-hidden">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-6 sm:left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-200 via-blue-300 to-transparent dark:from-blue-800 dark:via-blue-700"></div>
...
function CountdownTimer({ targetDate }: { targetDate: Date }) {
  ...
  return (
    <div className="flex gap-2">
      {timeLeft.days > 0 && (
        <div className="flex flex-col items-center min-w-[50px] bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-lg p-2">
...
function CalendarWidget({ date }: { date: Date | null }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center w-20 h-20 bg-gradient-to-br from-white to-slate-50 dark:from-slate-700 dark:to-slate-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-600 overflow-hidden"
    >
      <div className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs font-semibold text-center py-1">
        {monthShort}
      </div>
...
function InterviewCard({
  ...
  const urgencyConfig = {
    ...
    tomorrow: {
      ...
      icon: 'bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/40 dark:to-orange-800/40',
    ...
    future: {
      ...
      ring: '',
      icon: 'bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800',
  ...
  return (
    ...
    >
      ...
      >
        <Card
          className={`bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-slate-200/60 dark:border-slate-700/60 hover:shadow-xl transition-all duration-300 ${config.ring} overflow-hidden`}
        >
