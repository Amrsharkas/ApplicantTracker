...
export default function ProfilePage() {
  ...
  const autoSaveMutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      // Show toast with completion percentage
      const progressPercentage = (data as any)?.completionPercentage || 0;
      const statusMessage = progressPercentage >= 75
        ? t("interviewsUnlocked")
        : t("continueBuilding");
      const descriptionText = t("profileComplete")
        .replace("{{percentage}}", String(progressPercentage))
