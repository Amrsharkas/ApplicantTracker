...
export function InterviewHistoryModal({ isOpen, onClose, onResumeInterview }: InterviewHistoryModalProps) {
  ...
  // Also fetch user profile to check if comprehensive profile is available
  ...
  // Check if user has completed all 3 interview types and has unified profile
  const hasUnifiedProfile = userProfile?.aiProfileGenerated && completedInterviews.length === 3;
        ...
        <div className="overflow-y-auto flex-1 space-y-6 pr-2">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold flex items-center gap-2">
              ...
              Interview Components ({completedInterviews.length}/3)
            </h3>
            {hasUnifiedProfile && (
              <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-700">
                  ✓ All interview components completed! Your comprehensive AI profile has been generated from your personal, professional, and technical interviews.
                </p>
              </div>
            )}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <CardTitle className="text-lg">
                              Interview Component #{interview.id}
                            </CardTitle>
                        ...
                        {hasUnifiedProfile && (
                          <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <p className="text-sm text-blue-700">
                              📋 This unified profile was generated by combining insights from all three interview components: Personal, Professional, and Technical.
                            </p>
                          </div>
                        )}
