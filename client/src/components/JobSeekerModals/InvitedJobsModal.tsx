...
import { Building, Mic, MessageCircle, RefreshCw, Star } from "lucide-react";
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle className="text-2xl font-bold">Invited Jobs</DialogTitle>
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
          {isLoading ? (
            ...
            <div className="text-center py-12 text-slate-500">No invites yet.</div>
          ) : (
            invitedJobs.map((job) => (
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-3 items-center">
                      <div className="md:col-span-2">
                        <div className="text-sm text-slate-600 mb-2">Select Interview Language</div>
